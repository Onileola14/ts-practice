...
let city: string = "Abeokuta";
let yearsOfExperience: number = 1;
let isAvailableForHire: boolean = true;

// 3. When inference isn't enough: variables with no initial value
let email: string; // no value yet, but TypeScript still enforces the type
...
let response: unknown = "some API response";
